...
import Tabs, { TabPanel } from '../../plugin/common/component/tabs'
    ...
    render(props, state) {
        return (
            <Page option={state.option}>
                ...
                <h3>横向列表</h3>
                <Tabs active="0" scrollType="x" className="_v1">
                    <TabPanel label="一致性">
                        与现实生活一致：与现实生活的流程、逻辑保持一致，遵循用户习惯的语言和概念；<br/>
                        在界面中一致：所有的元素和结构需保持一致，比如：设计样式、图标和文本、元素的位置等。
                    </TabPanel>
